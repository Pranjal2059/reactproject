...
function SinglePage(){
  ...
  async function fetchBlog(){
    let response = await axios.get("https://67dba9491fd9e43fe4755320.mockapi.io/blogs/" + id)
  ...
  async function deleteBlog(){
   let response =  await axios.delete("https://67dba9491fd9e43fe4755320.mockapi.io/blogs/" + id)
   if(response.status == 200){
    navigate("/")
   }else{
    console.log("SOmething went wrong")
